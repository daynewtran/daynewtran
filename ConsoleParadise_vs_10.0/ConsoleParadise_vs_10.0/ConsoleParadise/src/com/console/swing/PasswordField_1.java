...
public class PasswordField_1 extends JPasswordField {
    ...
    public PasswordField_1() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/console/swing/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/console/swing/eye_hide.png")).getImage();
