...
public class Passwordfield extends JPasswordField {
    ...
    private Color lineColor = new Color(240,166,107);
    ...
    public Passwordfield() {
        ...
        TimingTarget target = new TimingTargetAdapter() {
         ...
         eye = new ImageIcon(getClass().getResource("/com/console/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/console/icon/eye_hide.png")).getImage();
